...
public class MyWishList extends AppCompatActivity {
    ...
    ArrayList<Subject> itemsArrayList;
    LVAdapter adapter;
    ...
    protected void onResume() {
        ...
        mDatabaseReference.child("subjects").addValueEventListener(new ValueEventListener() { //valueEventListener is used to update the database in RT
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.add:
                ...
                return true;
            case R.id.search:
               // Intent intent1 = new Intent(MyWishList.this,SearchActivity.class);
